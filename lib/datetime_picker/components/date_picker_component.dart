...
class _DatePickerState extends State<DatePickerComponent> {
  ...
  void _notifyDateChanged() {
    if (widget.route.onChanged != null) {
      widget.route.onChanged!(widget.pickerModel.finalTime()!);
    }
  }
          ...
          children: <Widget>[
            Container(
              child: widget.pickerModel.layoutProportions()[0] > 0
                  ? _renderColumnView(
                      ...
                      layoutProportion: widget.pickerModel.layoutProportions()[0],
                      selectedChangedWhenScrolling: (index) {
            ...
            Container(
              child: widget.pickerModel.layoutProportions()[1] > 0
                  ? _renderColumnView(
                      ...
                      layoutProportion: widget.pickerModel.layoutProportions()[1],
                      selectedChangedWhenScrolling: (index) {
            ...
            Container(
              child: widget.pickerModel.layoutProportions()[2] > 0
                  ? _renderColumnView(
                      key: ValueKey(widget.pickerModel.currentMiddleIndex() * 100 +
                          widget.pickerModel.currentLeftIndex()),
                      theme: theme,
                      stringAtIndexCB: widget.pickerModel.rightStringAtIndex,
                      scrollController: rightScrollCtrl,
                      layoutProportion: widget.pickerModel.layoutProportions()[2],
                      selectedChangedWhenScrolling: (index) {
  ...
  String _localeDone() {
    return i18nObjInLocale(widget.route.locale)['done'] as String;
  }

  String _localeCancel() {
    return i18nObjInLocale(widget.route.locale)['cancel'] as String;
  }
}
