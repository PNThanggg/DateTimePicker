...
class TimePickerSpinner extends StatefulWidget {
  ...
  final DateChangedCallback? onTimeChange;
...
class _TimePickerSpinnerState extends State<TimePickerSpinner> {
  ...
  /// default settings
  TextStyle defaultHighlightTextStyle = const TextStyle(fontSize: 32, color: Colors.blue);
  TextStyle defaultNormalTextStyle = const TextStyle(fontSize: 28, color: Colors.black54);
      ...
      SizedBox(
        ...
        child: spinner(
          ...
          (index) {
            ...
            debugPrint("Hour update:: $currentSelectedHourIndex");
      ...
      SizedBox(
        ...
        child: spinner(
          ...
          (index) {
            ...
            debugPrint("Minute update:: $currentSelectedMinuteIndex");
